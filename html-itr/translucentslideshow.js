...
translideshow.prototype={
	...
	init:function($, slidesHTML){
		...
		this.$wrapperdiv=$('#'+setting.wrapperid).css({position:'absolute', visibility:'visible', overflow:'hidden', width:setting.dimensions[0], height:setting.dimensions[1]}) //main DIV
