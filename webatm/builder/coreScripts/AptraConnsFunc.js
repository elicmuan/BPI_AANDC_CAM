   ...
   function removeAt(cookiesArr, index ) {
	...
	function ProcessPINEntered(result , value)
	{
		parent.frames["ACContainer"].ACCoreJS.ProcessPINEntered(result , value);
	}
	...
	function RESATMCFunc(status , additionalStatus , ATMCEvent)
	{
		parent.frames["ACContainer"].ACCoreJS.ATMCResponse(status , additionalStatus , ATMCEvent);
	}
	...
	{
		// parent.frames["atmcFrame"].GetPIN(type);
		KEYBOARD.GetPIN(type);
	}
